...
import {bundleHandlers, type PlannedArtifact,} from "../compiler/bundle-handlers.js";
...
export async function build(options: BuildOptions): Promise<void> {
  ...
  bundledFiles.forEach((file) => mkdirSync(dirname(file.filePath), {recursive: true}));
  bundledFiles.forEach((file) => writeArtifactFiles(file));
